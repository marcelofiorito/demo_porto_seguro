...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("PoliciesListListReport journey");
        ...
        opaTest("Start application", function (Given, When, Then) {
            ...
            Then.onThePoliciesListGenerated.iSeeThisPage();
        });
        ...
        //     When.onThePoliciesListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onThePoliciesListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onThePoliciesListGenerated.onTable(defaultTableId).iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onThePoliciesListGenerated.onFilterBar().iExecuteSearch();
            Then.onThePoliciesListGenerated.onTable(defaultTableId).iCheckRows();
            When.onThePoliciesListGenerated.onTable(defaultTableId).iPressRow(0);
